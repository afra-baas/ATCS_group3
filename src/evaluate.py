...
def evaluate_model_with_prompts(
    model, dataloader, language="en", num_prompts=5, product_item="this product"
):
    ...
    for data in dataloader:
        ...
        input_ids = torch.tensor(
            tokenizer.batch_encode_plus(input_text, padding=True, truncation=True)[
                "input_ids"
            ]
        )
